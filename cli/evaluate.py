...
Example
    python -m cli.evaluate --folder vit_cifar10_benign vit_cifar10_badnet_a2o_0_1
"""
...
def list_checkpoint_folders(checkpoints_dir: str) -> list[str]:
    """Every subdirectory of checkpoints_dir, in sorted order."""
...
def attack_label(checkpoint_dir: str) -> str:
    """The attack name from args.json, for the progress trace.

    Falls back to "unknown" rather than raising, because this only labels a log
...
def main() -> None:
    ...
    for folder_name in folder_names:
        ...
        attack = attack_label(checkpoint_dir)
