...
| [H20](H20-input-side-beats-residual-adjacent.md) | What matters is sub-layer input versus residual stream, not pre- versus post-residual | **SUPPORTED**: input-side beats residual-adjacent by **+0.054** (4.0 SE, 11/12 units) on a balanced panel; pre-versus-post, the founding question, is **+0.002** |
