...
| [H19](H19-placement-ranking-is-rate-selection.md) | The placement ranking is mostly about which placement the adaptive rate rule can aim at | **SUPPORTED**: on Swin all placements tie at the oracle (spread 0.017) and differ by 0.11 deployable; `blocks_9_12` has the best oracle AUROC in the project (0.997) and **0/20 deployable operating points** |
