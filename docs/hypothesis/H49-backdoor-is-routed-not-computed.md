...
## 3 phases (gtsrb badnet at 10%, n=2388 paired)
...
setting provides for free. Normalized recovery of the clean logit difference:
...
- **Trigger class.** A trigger needing routing is disruptable by token removal. 1 already in
