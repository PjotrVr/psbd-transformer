...
from .operators import build_perturbation
from .positions import DROPOUT_CONFIGS, plug_dropout, unplug_dropout
...
def calibrate_probe_rate(
    ...
    (psbd.decision.select_rate_at_matched_shift), so the attacker optimizes at the
