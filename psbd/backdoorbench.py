...
This is the PNG-backed twin of psbd.splits, which rebuilds a poisoned test set in
...
psbd.poisoning's eval-time function pair, never the training-time one.
"""
...
from .poisoning import attack_success_label, is_eval_poisonable
