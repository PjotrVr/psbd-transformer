...
from .evaluation import clean_accuracy
from .evasion import train_one_epoch_evasive
...
def sam_update(
    ...
    cost. See psbd.sam for the full caller contract.
    """
...
def save_checkpoint(
    ...
    """Save in the attack_result.pt format psbd.models.load_checkpoint reads.
...
def train_classifier(
    ...
    (psbd.evasion). It is the attacker's knob, not the defender's, and is recorded
